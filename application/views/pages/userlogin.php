<div class="row">
    <div class="col-md-6 col-md-offset-3">
        ...
        <div class="panel panel-default">
            <div class="panel-heading"><h3 class="text-center">Employee Login</h3></div>
            ...
            <div class="panel-body">
                ...
                <?php echo form_open('loginprocess',['id' => 'demo-form2"', 'class' => 'form-horizontal form-label-left']); ?>
                    ...
                    <div class="form-group">
                        ...
                        ?>
                         <a href = "<?php echo site_url();?>/reg" >Not Yet Register!</a>
                        </div>
